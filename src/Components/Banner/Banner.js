...
const Banner = () => {
    return (
        <div className="flex flex-col-reverse md:flex-row">
            <div className="md:w-3/5 md:my-auto my-5 mx-3">
                <h1 className="text-3xl md:text-5xl font-medium text-gray-800"><span className="text-black font-bold">Redmi</span> Buds 3 pro</h1>
                <h2 className="my-2.5 text-2xl md:text-3xl text-gray-700 font-medium">The sound you want</h2>
                <p className="mt-3.5">35dB Smart noise cancellation* | Dual-device connectivity | Wireless charging | 28h long battery life</p>
            </div>
